...
class Client{
public:
    Client(const std::string name, Leet::ID _id):m_name(name), id(_id), m_points(0) {}
...
public:
    ...
    Contest(const std::string name, Leet::ID _id, Level difficulty, const std::string creator_name):
                            m_name(name), id(_id), m_diff(difficulty), m_creatorName(creator_name) {}
...
class Question{
public:
    Question(const std::string name, Leet::ID _id, Level difficulty):m_name(name), id(_id), m_diff(difficulty){}
